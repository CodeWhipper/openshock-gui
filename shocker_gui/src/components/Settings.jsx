          ...
          <tbody>
            {names.map((n) => (
              <tr key={n.id}>
                <td>{n.name}</td>
                <td>
                  {renderSwitch(n.active, () =>
                    updateName(n.id, "active", !n.active)
                  )}
                </td>
                <td>
                  <input
                ...
                <td>
                  {renderSwitch(n.game_random, () =>
                    updateName(n.id, "game_random", !n.game_random)
                  )}
                </td>
                <td>
                  {renderSwitch(n.game_wheel, () =>
        ...
        <input
          ...
          onKeyDown={(e) => {
            if (e.key === "Enter") {
              ...
              if (trimmed) { addName(trimmed); setNewName(""); }
            }
          }}
        />
        <button
